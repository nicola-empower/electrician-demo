...
const defaultItems = [
    { title: "NICEIC Approved", subtitle: "Gold Standard", icon: ShieldCheck, colorClass: "text-red-600" },
    { title: "Part P Certified", subtitle: "Building Control", icon: Award, colorClass: "text-blue-600" },
    { title: "£5m Insurance", subtitle: "Fully Covered", icon: CheckCircle, colorClass: "text-green-600" }
];
